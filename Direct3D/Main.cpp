...
//generic GenerateWindow functions
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	if (GenerateWindow(hInstance, nCmdShow, "Direct3D", "GraphicsDevice implementation - green background", 1280, 720, hWnd))
	{
		MSG msg;
		game = new Game();
...
//Window Proc - Handles inputs sent to the window
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
